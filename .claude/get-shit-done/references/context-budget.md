...
The keys live in `.claude/settings.json` (project) or `C:/Users/Gilang Dwi/OneDrive/Documents/00. Claude AI/Claude Project/4. Fintrack/.claude/settings.json` (global) — **not** in `.planning/config.json`:
