...
HELP_PAGES = {
    ...
    "transactions": (
        ...
        "Langsung ketik apa yang terjadi, AI yang kerjakan sisanya!\n\n"
        "_Pengeluaran:_\n"
        "• `beli kopi 15k`\n"
        "• `makan siang 75000`\n"
        "• `bayar listrik 1.5jt`\n\n"
        ...
        "AI otomatis tahu itu pengeluaran atau pemasukan, dan kategorikannya 🧠\n\n"
        "━━━━━━━━━━━━━━━━━━━━\n"
        ...
        "• Nama bulan: `@5mei` · `@5 may` · `@may 5`\n\n"
        "*Perintah lainnya:*\n"
        "/history · /stats · /delete · /commands",
        InlineKeyboardMarkup([
    ...
    "budget": (
        ...
        "🤖 *Set Budget via Quick Wizard (direkomendasikan):*\n"
        "Gunakan tombol interaktif tanpa harus hafal command!\n"
        "Ketuk 💰 Budget di menu utama → pilih kategori → masukkan nominal.\n\n"
        "━━━━━━━━━━━━━━━━━━━━\n"
        "⌨️ *Atau pakai command:*\n"
        "`/budget <kategori> <nominal>`\n"
        "Contoh: `/budget food 1jt`\n\n"
        "*Kategori:* food · groceries · transport · shopping\n"
        "health · entertainment · bills · education\n\n"
        "*Lihat Progress Budget:*\n"
        "/summary → termasuk budget vs aktual\n\n"
        "━━━━━━━━━━━━━━━━━━━━\n"
        "🎯 *Savings Goals:*\n"
        "Tambah goal impianmu, lalu alokasikan tabungan ke sana!\n\n"
...
QUICK_GUIDES = {
    "add": (
        ...
        "Cukup tulis apa yang kamu beli beserta nominalnya, tanpa command apapun!\n\n"
        "• `beli kopi 15000`\n"
        "• `makan siang 75k`\n"
        "• `bayar listrik 1.5jt`\n"
        "• `grab ke kantor 25rb kemarin`\n\n"
        "AI akan otomatis mengenali nominal, kategori, dan tanggalnya 🧠\n\n"
        "━━━━━━━━━━━━━━━━━━━━\n"
        ...
        "• Nama bulan: `/add 50000 makan @5mei` · `@5 may` · `@may 5`"
    ),
    "income": (
        "💚 *Catat Pemasukan*\n\n"
        "🤖 *Cara termudah — ketik natural language:*\n"
        "Cukup tulis sumber pemasukanmu beserta nominalnya, tanpa command apapun!\n\n"
        "• `gaji april 5jt`\n"
        "• `freelance desain 500k`\n"
        "• `transfer dari klien 2jt`\n\n"
        "AI akan otomatis mengenali ini sebagai pemasukan 🧠\n\n"
        "━━━━━━━━━━━━━━━━━━━━\n"
        "⌨️ *Atau gunakan command:*\n"
        "`/income <nominal> <keterangan>`\n\n"
        "Contoh:\n"
